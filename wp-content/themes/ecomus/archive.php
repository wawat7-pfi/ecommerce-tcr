...
<?php if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'archive' ) ) { ?>
	<div class="site-content-container">
		<?php do_action('ecomus_before_open_archive'); ?>
		<div id="primary" class="content-area">
			<?php do_action('ecomus_before_archive_content'); ?>
			...
			<?php do_action('ecomus_after_archive_content'); ?>
		</div>
		<?php do_action('ecomus_after_close_archive'); ?>
	<?php
		get_sidebar();
	?>
	</div>
